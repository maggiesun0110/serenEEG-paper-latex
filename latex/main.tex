...
%      \toprule
%      Model & Accuracy & Prec(0) & Prec(1) & Recall(0) & Recall(1) & F1\\
%      \midrule
...
% \toprule
% Model & Accuracy & Prec(0) & Prec(1) & Rec(0) & Rec(1) & F1 \\
% \midrule
% RF (CNN emb)  & 96.95 & 88.89 & 97.54 & 72.73 & 99.17 & 98.35 \\
% XGB (CNN emb) & 96.95 & 88.89 & 97.54 & 72.73 & 99.17 & 98.35 \\
% \bottomrule
% \end{tabular}
% \end{table}
...
Stage & Description \\
\midrule
Filtering      & 0.5--40 Hz Butterworth bandpass to remove drift and high-frequency noise \\
